...
- Can save/load constructed data to external storage.
{% endobjective %}

In this section, we will show how to setup suitable data for building predictive models to predict heart failure (HF). We will first briefly introduce data types involved. Then we show how to construct training/testing samples from scratch using Spark RDD operations you have learned. Finally we will export data in suitable format for later analysis.
