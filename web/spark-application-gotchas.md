---
layout: post
title: Spark Application Gotchas
navigation:
  section: [3, 3]
---
{% objective %}
- Understand serialization to workers of members, accumulators, and broadcasts
- Demonstrate examples of issues and solutions
{% endobjective %}

In this section, we will discuss and demonstrate nuances when using Spark and discuss why things are happening, and solutions.
